...
<head>
  ...
  <title>Fast Delivery — Automotive Hub Platform</title>
...
<nav>
  ...
  <ul class="nav-links">
    ...
    <li><a href="fast-delivery.php" class="active">Fast Delivery</a></li>
  </ul>
...
<div class="page-header">
  <div class="ph-label">Automotive Hub Platform — Express Shipping</div>
  <h1 class="ph-title">Fast <span>Delivery</span></h1>
  <p class="ph-sub">Items available for immediate fast delivery</p>
</div>
...
<div class="section-wrap">
  <div class="section-head">
    <h2>Available Now — Fast Delivery</h2>
...
const items = [
  ...
  },
  {
    ...
    price: '$276,550',
    desc: 'A tribute to the most powerful V8 in Ferrari history — pure Maranello passion and performance.',
    specs: [
    ...
    rows: [
      ...
      { label: 'Origin', val: 'Italy' },
      { label: 'Warranty', val: '3 Years' },
      { label: 'Availability', val: 'Limited Stock' },
    ]
  },
  {
    cat: 'car', catLabel: 'Car', badgeClass: 'badge-car',
    name: 'Rolls-Royce Ghost',
    brand: 'Rolls-Royce • 2024',
    stars: '★★★★★', rating: '5.0',
    img: 'images/Rolls-Royce Ghost.jpg',
    price: '$332,500',
    desc: 'The pinnacle of automotive luxury — hand-crafted perfection with a twin-turbo V12 and whisper-quiet ride.',
    specs: [
      { icon: '⚡', label: 'Engine', val: '6.75L V12' },
      { icon: '💨', label: 'Power', val: '563 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '4.8 sec' },
      { icon: '🔝', label: 'Top Speed', val: '250 km/h' },
      { icon: '⛽', label: 'Fuel', val: 'Petrol' },
      { icon: '⚙️', label: 'Gearbox', val: '8-Speed Auto' },
      { icon: '🛞', label: 'Drive', val: 'AWD' },
      { icon: '📦', label: 'Body', val: 'Saloon' },
    ],
    rows: [
      { label: 'Category', val: 'Ultra Luxury' },
      { label: 'Origin', val: 'United Kingdom' },
      { label: 'Warranty', val: '4 Years' },
      { label: 'Availability', val: 'Bespoke Order' },
    ]
  },
  {
    cat: 'car', catLabel: 'Car', badgeClass: 'badge-car',
    ...
    price: '$299,000',
    desc: 'Carbon-fiber supercar with active aerodynamics and mind-bending 0-100 in 2.9 seconds.',
    specs: [
      { icon: '⚡', label: 'Engine', val: '4.0L Twin-V8' },
      { icon: '💨', label: 'Power', val: '720 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '2.9 sec' },
      { icon: '🔝', label: 'Top Speed', val: '341 km/h' },
      { icon: '⛽', label: 'Fuel', val: 'Petrol' },
      { icon: '⚙️', label: 'Gearbox', val: '7-Speed SSG' },
      { icon: '🛞', label: 'Drive', val: 'RWD' },
      { icon: '📦', label: 'Body', val: 'Coupe' },
    ],
    rows: [
      ...
      { label: 'Origin', val: 'United Kingdom' },
      { label: 'Warranty', val: '3 Years' },
      { label: 'Availability', val: 'Order Only' },
    ]
  },
  ...
  // ── MOTORCYCLES ──
  {
    ...
    brand: 'Ducati • 2024',
    stars: '★★★★★', rating: '5.0',
    img: 'images/Ducati Panigale V4.jpg',
    price: '$28,395',
    desc: 'MotoGP-derived V4 engine in a street-legal body — the most powerful Ducati superbike ever made.',
    specs: [
      { icon: '⚡', label: 'Engine', val: '1103cc V4' },
      { icon: '💨', label: 'Power', val: '214 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '2.7 sec' },
      { icon: '🔝', label: 'Top Speed', val: '299 km/h' },
      { icon: '⛽', label: 'Fuel', val: 'Petrol' },
      { icon: '⚙️', label: 'Gearbox', val: '6-Speed' },
      { icon: '🛞', label: 'Drive', val: 'Chain' },
      { icon: '📦', label: 'Type', val: 'Superbike' },
    ],
    rows: [
      { label: 'Category', val: 'Superbike' },
      { label: 'Origin', val: 'Italy' },
  ...
  },
  {
    ...
    brand: 'Kawasaki • 2024',
    stars: '★★★★★', rating: '4.9',
    img: 'images/Kawasaki Ninja ZX-10R.jpg',
    price: '$17,399',
    desc: 'World Superbike champion DNA — track-tuned aerodynamics and electronics for ultimate performance.',
    specs: [
  ...
  },
  {
    ...
    price: '$17,999',
    desc: 'Crossplane crankshaft inline-4 with MotoGP-derived tech — pure racetrack performance for the road.',
    specs: [
      { icon: '⚡', label: 'Engine', val: '998cc CP4' },
      { icon: '💨', label: 'Power', val: '200 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '3.0 sec' },
      { icon: '🔝', label: 'Top Speed', val: '299 km/h' },
      { icon: '⛽', label: 'Fuel', val: 'Petrol' },
      { icon: '⚙️', label: 'Gearbox', val: '6-Speed' },
      { icon: '🛞', label: 'Drive', val: 'Chain' },
      { icon: '📦', label: 'Type', val: 'Supersport' },
    ],
    rows: [
      { label: 'Category', val: 'Supersport' },
      { label: 'Origin', val: 'Japan' },
      { label: 'Warranty', val: '2 Years' },
      { label: 'Availability', val: 'In Stock' },
    ]
  },
  {
    ...
    brand: 'Honda • 2024',
    stars: '★★★★★', rating: '4.8',
    img: 'images/Honda Gold Wing.jpg',
    price: '$23,300',
    desc: 'The ultimate touring motorcycle — flat-6 engine, DCT gearbox, and unmatched long-distance comfort.',
    specs: [
      { icon: '⚡', label: 'Engine', val: '1833cc Flat-6' },
      { icon: '💨', label: 'Power', val: '126 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '5.5 sec' },
      { icon: '🔝', label: 'Top Speed', val: '185 km/h' },
      { icon: '⛽', label: 'Fuel', val: 'Petrol' },
      { icon: '⚙️', label: 'Gearbox', val: 'DCT 7-Speed' },
      { icon: '🛞', label: 'Drive', val: 'Shaft' },
      { icon: '📦', label: 'Type', val: 'Touring' },
    ],
    rows: [
      { label: 'Category', val: 'Grand Touring' },
      { label: 'Origin', val: 'Japan' },
      { label: 'Warranty', val: '3 Years' },
      { label: 'Availability', val: 'In Stock' },
    ]
  ...
  // ── ELECTRIC ──
  {
    ...
    price: '$89,990',
    desc: 'The fastest production car ever — tri-motor electric with 1020 hp and 0-100 in under 2.1 seconds.',
    specs: [
      { icon: '⚡', label: 'Motors', val: 'Tri-Motor' },
      { icon: '💨', label: 'Power', val: '1020 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '2.1 sec' },
      { icon: '🔝', label: 'Top Speed', val: '322 km/h' },
      { icon: '🔋', label: 'Range', val: '637 km' },
      { icon: '⚡', label: 'Charge', val: '250 kW' },
      { icon: '🛞', label: 'Drive', val: 'AWD' },
  ...
  },
  {
    ...
    brand: 'Lucid • 2024',
    stars: '★★★★★', rating: '4.9',
    img: 'images/Lucid Air.jpg',
    price: '$138,000',
    desc: 'Longest range EV ever built — 836 km on a single charge with a futuristic glass canopy interior.',
    specs: [
      { icon: '⚡', label: 'Motors', val: 'Dual Motor' },
      { icon: '💨', label: 'Power', val: '819 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '3.0 sec' },
      { icon: '🔝', label: 'Top Speed', val: '270 km/h' },
      { icon: '🔋', label: 'Range', val: '836 km' },
      { icon: '⚡', label: 'Charge', val: '300 kW' },
      { icon: '🛞', label: 'Drive', val: 'AWD' },
      { icon: '📦', label: 'Body', val: 'Sedan' },
    ],
    rows: [
      { label: 'Category', val: 'Electric Luxury' },
      { label: 'Origin', val: 'USA' },
      { label: 'Warranty', val: '4 Years' },
      { label: 'Availability', val: 'In Stock' },
    ]
  },
  {
    ...
    brand: 'Mercedes-Benz • 2024',
    stars: '★★★★★', rating: '4.9',
    img: 'images/Mercedes EQS.jpg',
    price: '$104,400',
    desc: 'The electric S-Class — 56-inch Hyperscreen, ultra-luxury interior, and 770 km of range.',
    specs: [
      { icon: '⚡', label: 'Motors', val: 'Dual Motor' },
      { icon: '💨', label: 'Power', val: '516 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '4.3 sec' },
      { icon: '🔝', label: 'Top Speed', val: '210 km/h' },
      { icon: '🔋', label: 'Range', val: '770 km' },
      { icon: '⚡', label: 'Charge', val: '200 kW' },
      { icon: '🛞', label: 'Drive', val: 'AWD' },
      { icon: '📦', label: 'Body', val: 'Saloon' },
    ],
    rows: [
  ...
  },
  {
    ...
    brand: 'Rivian • 2024',
    stars: '★★★★★', rating: '4.8',
    img: 'images/Rivian R1T1.jpg',
    price: '$73,000',
    desc: "The world's first electric adventure truck — quad-motor AWD and 560 km range for any terrain.",
    specs: [
      { icon: '⚡', label: 'Motors', val: 'Quad Motor' },
      { icon: '💨', label: 'Power', val: '835 HP' },
      { icon: '🏎', label: '0–100 km/h', val: '3.0 sec' },
      { icon: '🔝', label: 'Top Speed', val: '201 km/h' },
      { icon: '🔋', label: 'Range', val: '560 km' },
      { icon: '⚡', label: 'Charge', val: '220 kW' },
      { icon: '🛞', label: 'Drive', val: 'AWD' },
      { icon: '📦', label: 'Body', val: 'Pickup Truck' },
    ],
    rows: [
  ...
  // ── SPARE PARTS ──
  {
    ...
    price: '$2,800',
    desc: '6-piston monoblock caliper brake kit — track-proven stopping power used by F1 and supercar manufacturers.',
    specs: [
      { icon: '🔧', label: 'Type', val: '6-Piston Monoblock' },
      { icon: '📏', label: 'Disc Size', val: '380mm' },
  ...
  grid.innerHTML = list.map((item, i) => `
    <div class="item-card ${item.cat}" style="animation-delay:${i * 0.05}s">
      <div class="card-img">
        ...
        <span class="prime-tag">⚡ Fast Delivery</span>
      ...
      <div class="card-body">
        ...
        <div class="card-actions">
          ...
          <button class="btn-wish" onclick="handleWish(this)">♡</button>
        </div>
      </div>
    </div>
  `).join('');
...
// Keep track of filtered list for correct panel index
let currentList = [];
...
function openPanel(idx) {
  ...
  document.getElementById('pSpecs').innerHTML = it.specs.map(s => `
  ...
  document.getElementById('pRows').innerHTML = it.rows.map(r => `
    <div class="panel-row">
...
function handleWish(btn) {
  ...
  btn.style.borderColor = btn.style.borderColor === 'rgb(239, 68, 68)' ? '' : '#ef4444';
}

// Show only In Stock items by default
const inStockItems = items.filter(it => it.rows.some(r => r.label === 'Availability' && r.val === 'In Stock'));

function filterItems(cat, btn) {
  document.querySelectorAll('.fbtn').forEach(b => b.classList.remove('active'));
  btn.classList.add('active');
  currentCat = cat;
  currentList = cat === 'all' ? inStockItems : inStockItems.filter(i => i.cat === cat);
  renderCards(currentList);
}

// Initial render
currentList = inStockItems;
renderCards(currentList);
</script>
</body>
</html>
